...
export function createKeyboardState(aircraft = 'cessna') {
    ...
    // Pointer clicks operate game buttons without leaving keyboard focus behind.
    // Keep normal focus/navigation for actual form inputs and keyboard users.
    ...
    document.addEventListener('click', (event) => {
        ...
        if (button instanceof HTMLElement) {
            button.blur();
            // showModal() can autofocus another button during the same click.
    ...
    // Space belongs to flight, even if a toolbar button was focused previously.
    // Capture it before the minimap's keyboard handler or native button activation.
