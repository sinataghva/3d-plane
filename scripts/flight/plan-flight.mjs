...
import { getVerticalSpeed, getAltitude } from '../../src/flight/flightMetrics.js';
const world = createGeography(
    JSON.parse(fs.readFileSync('data/saint-cyr/map.json')),
...
fs.writeFileSync('tests/fixtures/flights/scenic-tour.json', JSON.stringify(stages));
