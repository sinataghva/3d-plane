...
Requires Pillow. Run from repository root. Original tiles cached in data/saint-cyr/cache/.
"""
import math, json, urllib.request, pathlib, io
from PIL import Image
from scenery_regions import BOUNDS, CACHE, DEM_FILE, REGION
south,west,north,east=BOUNDS
zoom=11 if REGION == 'luxeuil' else 12
